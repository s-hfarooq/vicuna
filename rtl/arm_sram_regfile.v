...
//
//      Instance Name:              sram_512word_32bit_wmask_8partition
//      Words:                      512
//      Bits:                       32
//      Mux:                        16
//      Drive:                      6
...
//      Test Muxes                  Off
//
//      Creation Date:  Thu Nov  3 03:11:25 2022
//      Version: 	r0p0-00eac0
//
...
`celldefine
`ifdef POWER_PINS
module sram_512word_32bit_wmask_8partition (Q, CLK, CEN, WEN, A, D, EMA, GWEN, RETN,
    VSSE, VDDPE, VDDCE);
`else
module sram_512word_32bit_wmask_8partition (Q, CLK, CEN, WEN, A, D, EMA, GWEN, RETN);
`endif
...
`endif
 ...
 wire  CLK_;
  ...
  buf B77(D_[30], D[30]);
  buf B78(D_[31], D[31]);
  buf B79(EMA_[0], EMA[0]);
  buf B80(EMA_[1], EMA[1]);
  buf B81(EMA_[2], EMA[2]);
  buf B82(GWEN_, GWEN);
  buf B83(RETN_, RETN);
